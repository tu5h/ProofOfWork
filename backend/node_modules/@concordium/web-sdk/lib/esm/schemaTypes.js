...
import { Cursor, deserializeBigUInt64LE, deserializeUInt8, deserializeUInt16LE, deserializeUInt32LE, } from './deserializationHelpers.js';
 ...
 */
export function toOptionJson(value) {
    if (value === undefined) {
        return { None: [] };
    }
    return { Some: [value] };
 ...
 */
export function parseRawModuleSchema(rawModuleSchema) {
 ...
 */
export function deserializeVersionedSchemaModule(cursor) {
 ...
 * @returns {VersionedSchemaModule} The structured representation of a smart contract schema module.
 */
export function deserializeUnversionedSchemaModule(version, cursor) {
    switch (version) {
        case 0:
            return { version, module: deserializeSchemaModuleV0(cursor) };
        case 1:
 ...
 */
export function deserializeSchemaType(buffer) {
 ...
 */
export function serializeSchemaType(schemaType) {
 ...
 * @returns {Uint8Array} Buffer with serialization.
 */
function serializeList(sizeLength, serialItem, list) {
 ...
 * @returns {Uint8Array} Buffer with serialization.
 */
function serializeMap(sizeLength, serialKey, serialValue, map) {
