import { Authorizations, AuthorizationsV1, BlockInfo, BlockInfoV0, BlockInfoV1, ChainParameters, ChainParametersV0, ChainParametersV1, ChainParametersV2, ConsensusStatus, ConsensusStatusV0, ConsensusStatusV1, ElectionInfo, ElectionInfoV0, ElectionInfoV1, InstanceInfo, InstanceInfoV0, InstanceInfoV1, RewardStatus, RewardStatusV1 } from './types.js';
/**
 * Whether {@link Authorizations} parameter given is of type {@link AuthorizationsV1}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isAuthorizationsV1: (as: Authorizations) => as is AuthorizationsV1;
/**
 ...
 * @deprecated check the `version` member instead.
 */
export declare const isChainParametersV2: (cp: ChainParameters) => cp is ChainParametersV2;
/**
 * Whether {@link BlockInfo} parameter given is of type {@link BlockInfoV0}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isBlockInfoV0: (bi: BlockInfo) => bi is BlockInfoV0;
/**
 * Whether {@link BlockInfo} parameter given is of type {@link BlockInfoV1}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isBlockInfoV1: (bi: BlockInfo) => bi is BlockInfoV1;
/**
 * Whether {@link ConensusStatus} parameter given is of type {@link ConsensusStatusV0}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isConsensusStatusV0: (cs: ConsensusStatus) => cs is ConsensusStatusV0;
/**
 * Whether {@link ConensusStatus} parameter given is of type {@link ConsensusStatusV1}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isConsensusStatusV1: (cs: ConsensusStatus) => cs is ConsensusStatusV1;
/**
 * Whether {@link ElectionInfo} parameter given is of type {@link ElectionInfoV0}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isElectionInfoV0: (ei: ElectionInfo) => ei is ElectionInfoV0;
/**
 * Whether {@link ElectionInfo} parameter given is of type {@link ElectionInfoV1}
 *
 * @deprecated check the `version` member instead.
 */
export declare const isElectionInfoV1: (ei: ElectionInfo) => ei is ElectionInfoV1;
/**
