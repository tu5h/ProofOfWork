 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeUInt8(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeUInt16LE(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeUInt32LE(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeBigUInt64LE(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeUInt16BE(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeUInt32BE(cursor) {
 ...
 * @throws If the buffer contains fewer bytes than being read.
 */
export function deserializeBigUInt64BE(cursor) {
 ...
 */
export const makeDeserializeListResponse = (deserializer) => (value) => {
 ...
 */
export const ensureMatchesInput = (input, deserializer) => (value) => {
