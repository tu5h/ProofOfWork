 ...
 * @returns {InitName}
 */
export function fromContractName(contractName) {
 ...
 */
export function toString(initName) {
 ...
 * @returns {InitName}
 */
export function fromProto(initName) {
 ...
 */
export function toProto(initName) {
    return {
...
//# sourceMappingURL=InitName.js.map