 ...
 * @returns {ReceiveName} The receive name.
 */
export function create(contractName, entrypointName) {
 ...
 * @returns {ReceiveName}
 */
export function fromStringUnchecked(value) {
    return new ReceiveName(value);
}
/**
 ...
 * @returns {string}
 */
export function toString(receiveName) {
 ...
 */
export function toContractName(receiveName) {
 ...
 */
export function toEntrypointName(receiveName) {
    const splitAt = receiveName.value.indexOf('.');
 ...
 */
export function toSchemaValue(receiveName) {
 ...
 * @returns {ReceiveName} The receive name.
 */
export function fromSchemaValue(receiveName) {
 ...
 * @returns {ReceiveName}
 */
export function fromProto(receiveName) {
 ...
 */
export function toProto(receiveName) {
    return {
...
//# sourceMappingURL=ReceiveName.js.map