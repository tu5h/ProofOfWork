...
declare class ModuleClient {
    ...
    readonly moduleReference: ModuleReference.Type;
...
export declare function instanceOf(value: unknown): value is ModuleClient;
/**
 ...
 */
export declare function createUnchecked(grpcClient: ConcordiumGRPCClient, moduleReference: ModuleReference.Type): ModuleClient;
/**
 * Create a new `GenericModule` instance for interacting with a smart contract module on chain.
 ...
 * @returns {ModuleClient}
 */
export declare function create(grpcClient: ConcordiumGRPCClient, moduleReference: ModuleReference.Type): Promise<ModuleClient>;
/**
 ...
 */
export declare function checkOnChain(moduleClient: ModuleClient, blockHash?: BlockHash.Type): Promise<void>;
/**
 ...
 */
export declare function getModuleSource(moduleClient: ModuleClient, blockHash?: BlockHash.Type): Promise<VersionedModuleSource>;
/**
 ...
 */
export declare function createAndSendInitTransaction(moduleClient: ModuleClient, contractName: ContractName.Type, metadata: ContractTransactionMetadata, parameter: Parameter.Type, signer: AccountSigner): Promise<TransactionHash.Type>;
export {};
