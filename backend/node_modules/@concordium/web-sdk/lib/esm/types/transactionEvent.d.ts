import type { Address, BakerId, ContractVersion, DelegatorId, EventDelegationTarget, HexString, ModuleRef, OpenStatusText, ReleaseSchedule } from '../types.js';
...
export type BakerEvent = BakerSetTransactionFeeCommissionEvent | BakerSetBakingRewardCommissionEvent | BakerSetFinalizationRewardCommissionEvent | BakerSetMetadataURLEvent | BakerSetOpenStatusEvent | BakerSetRestakeEarningsEvent | BakerStakeChangedEvent | BakerAddedEvent | BakerRemovedEvent | BakerKeysUpdatedEvent;
export type DelegationEvent = DelegatorEvent | DelegationSetDelegationTargetEvent | DelegationSetRestakeEarningsEvent | DelegationStakeChangedEvent;
