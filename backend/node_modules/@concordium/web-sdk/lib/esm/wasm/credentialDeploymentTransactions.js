 ...
 */
export function createCredentialDeploymentTransaction(identity, cryptographicParameters, threshold, publicKeys, credentialIndex, revealedAttributes, expiry) {
 ...
 */
export function createCredentialTransaction(input, expiry) {
 ...
 */
export function createCredentialTransactionNoSeed(input, expiry) {
