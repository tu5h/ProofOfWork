 ...
 * if a > b then compareStringAttributes(a,b) = 1;
 */
export function compareStringAttributes(a, b) {
 ...
 */
export function isStringAttributeInRange(value, lower, upper) {
 ...
 */
export function timestampToDate(attribute) {
 ...
 */
export function dateToTimestampAttribute(value) {
    return {
        type: 'date-time',
 ...
 */
export function statementAttributeTypeToAttributeType(statementAttribute) {
...
export function parseYearMonth(yearMonth) {
    ...
    if (Number.isNaN(year) || Number.isNaN(month) || month > 11)
        b();
